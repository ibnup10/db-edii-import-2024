...
columns_to_remove = ["SERI BARANG", "KODE SATUAN", "JUMLAH SATUAN", "KODE KEMASAN", "JUMLAH KEMASAN", "Jumlah Nilai CIF"]
...
def main():
    ...
    if data is not None:
        ...
        # Proses pencarian jika kolom dan kata kunci dipilih
        ...
        # Format tanggal agar tampil dengan format yang sesuai
